...
def main():
    ...
    # This is the data set from the Udacity course.  Our result for information
    # gain agrees with the udacity result and my hand calculated result.
    # https://classroom.udacity.com/courses/ud120/lessons/2258728540/concepts/24351485590923
